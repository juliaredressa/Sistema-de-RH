...
export default class Database {
    ...
    constructor() {
        ...
        this.#conexao = mysql.createPool({
            ...
            database: 'PFS2_10442313163', //a database de cada um de vocês possui a nomenclatura DB_(RA)
            user: '10442313163', // usuario e senha de cada um de vocês é o RA
            password: '10442313163',
        });
    }
